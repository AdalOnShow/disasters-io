...
const MobileNav = ({ toggleMenu }) => {
    return (
        <nav
            className="lg:hidden fixed top-[70px] left-0 right-0 h-screen bg-secondary py-4 px-2 flex gap-4 flex-col justify-start pt-8 items-center z-50">
            <div className="flex items-center justify-start gap-4 pb-4">
                <img src={"/assets/nav/notification.png"} alt="" className="size-10 cursor-pointer" />
