        ...
        <div className="">
            ...
            <div className="container mx-auto mt-8 sm:mt-11 md:mt-16 lg:mt-24 lg:max-w-[815px] flex flex-col items-center justify-center gap-[33px]">
                ...
                <div className="max-w-[350px] sm:w-[400px] md:w-[500px] lg:w-[609px] flex justify-center items-center relative">
                    <div className="w-[350px] sm:w-[390px] md:w-[490px] lg:w-[598px] h-[3px] bg-secondary" />
                ...
                <div className="flex justify-between items-center gap-4 sm:gap-8 md:gap-10 lg:gap-[55px]">
                    {
                        incidentsStarted.map(({ img, title, des }, index) => (
                            <div key={index} className="w-28 sm:w-40 md:w-52 lg:w-[235px] h-48 sm:h-52 md:h-60 lg:h-[270px] bg-[#F4F4F5] rounded-[10px] p-3 md:p-5 hover:bg-secondary transition-colors duration-200">
                                <img src={img} alt="" className="size-6 sm:size-8 md:size-10 lg:size-[54px]" />
