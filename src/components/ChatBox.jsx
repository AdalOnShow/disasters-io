const ChatBox = () => {
    return (
        <div className="z-50">
            <div className="fixed bottom-[150px] right-4 w-[331px]">
                <div className="bg-[#F4F4F5] rounded-xl max-w-[331px] w-full">
                    <div className="p-6 bg-primary text-white rounded-t-xl">
                    ...
                    <div className="px-4">
                        ...
                        <div className="flex justify-between items-center py-2">
                            <div className="flex items-center justify-center cursor-pointer">
                                <img src={"../src/assets/dashboard/camera.svg"} alt="" />
                                <img src={"../src/assets/dashboard/photo.svg"} alt="" />
                                <img src={"../src/assets/dashboard/more.svg"} alt="" />
                            </div>
